...
import (
	...
	errConstans "user-service/constants/error"
...
type IUserRepository interface {
	...
	Update(context.Context, *dto.UpdatedRequest, string) (*models.User, error)
...
func (ur *UserRepository) Register(ctx context.Context, req *dto.RegisterRequest) (*models.User, error){
	...
	if err != nil{
		return nil, errWrap.WrapError(errConstans.ErrSQLError)
	}
	return &user, nil
}

func (ur *UserRepository) Update(ctx context.Context,req *dto.UpdatedRequest, uuid string) (*models.User, error){
	user := models.User{
		Name: req.Name,
		Username: req.Username,
		Password: *req.Password,
...
func (ur *UserRepository) FindByUserName(ctx context.Context, username string) (*models.User, error){
	...
	if err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound){
			return nil, errConstans.ErrUserNotFound
		}
		return nil, errWrap.WrapError(errConstans.ErrSQLError)
	}
	return &user, nil
